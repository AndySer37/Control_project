...
double theta_omega_l;
double theta_omega_r;
...
void loop() {
  ...
  while(1)
  {
    ...
    if(UpdateAttitude())
    {
      ...
      {  
        theta_omega_l = encoderPosL/CPR * PI * 2;
        theta_omega_r = encoderPosR/CPR * PI * 2;
       //PWM_Calculate();
#ifdef MEASURE_PARAMETER_V
